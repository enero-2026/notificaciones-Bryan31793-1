...
const enviarNotificacion = async () => {
  await Notifications.scheduleNotificationAsync({
    content: {
      title: "Hola, mundo 👋",
      body: "Esta es tu primera notificacion",
    },
    trigger: null, // Este trigger lo puedes modificar para darle unos segundos de delay, ejemplo
  });
};
...
export default function App() {
  ...
  return (
    <View style={{ marginTop: 50 }}>
      ...
      <Button title="Pedir permiso" onPress={pedir_permiso} />
